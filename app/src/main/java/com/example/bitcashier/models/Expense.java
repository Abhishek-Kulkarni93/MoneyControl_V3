...
public class Expense {
    ...
    public static final String CREATE_EXPENSE_TABLE = "CREATE TABLE IF NOT EXISTS " + EXPENSE_TABLE + " ("+ID +" INTEGER PRIMARY KEY AUTOINCREMENT,"+ AMOUNT +" REAL NOT NULL,"+ TITLE +" TEXT NOT NULL,"+ DATE +" TEXT NOT NULL,"+ CATEGORY +" TEXT NOT NULL,"+ PAYMENT_TYPE +" TEXT NOT NULL,"+ NOTES +" TEXT,"+ RECURRING +" TEXT DEFAULT 'no',"+ USER_NAME +" TEXT NOT NULL) ";
